// src/lib.rs
/*
 * Core library for TaxCalculation
 */
...
#[derive(Debug)]
pub struct TaxCalculationProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TaxCalculationProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TaxCalculation processing");
    
    let mut processor = TaxCalculationProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TaxCalculationProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TaxCalculationProcessor::new(false);
